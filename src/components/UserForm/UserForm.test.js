...
test('should call onSave when form is valid', () => {
		...
		fireEvent.change(screen.getByLabelText('Nome do usuário'), { target: { value: 'John Doe' } });
		fireEvent.change(screen.getByLabelText('Data de Nascimento'), { target: { value: '1990-01-01' } });
		fireEvent.change(screen.getByLabelText('Telefone'), { target: { value: '(12)34567-8901' } });
		fireEvent.change(screen.getByLabelText('E-mail do usuário'), { target: { value: 'john.doe@example.com' } });
