import { addUser , updateUser , deleteUser , saveUsers, getUsers } from './userService';
...
describe('User  Service', () => {
  ...
  beforeEach(() => {
    ...
    users = [
      { nome: 'User  1', dataNasc: '1990-01-01', telefone: '1234567890', email: 'user1@example.com' },
      { nome: 'User  2', dataNasc: '1992-02-02', telefone: '0987654321', email: 'user2@example.com' },
    ];
  ...
  test('should save users to localStorage', () => {
    ...
    expect(localStorage.setItem).toHaveBeenCalledWith('db_usur', JSON.stringify(usersToSave));
  });
});